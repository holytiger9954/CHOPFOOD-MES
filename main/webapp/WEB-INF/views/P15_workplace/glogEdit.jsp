...
<div class="content">
    ...
    <div class="header-row">
        <div>
            ...
            <p class="page-subtitle">${glog.glogWpName}(${glog.glogWpId})의 위생점검이력(${glog.glogId}) 결과를 수정하세요.</p>
        </div>
    ...
    <form action="${pageContext.request.contextPath}/workplace/glog/update"
		...
		<div class="grid-wrap">
			...
			<div class="grid search-item">
				<label>측정값</label>
				<input type="number" name="glogValue" id="glogValue" value="${glog.glogValue}" placeholder="측정값 입력">
			</div>
		</div>
