...
<div class="content">
    ...
    <div class="header-row">
        ...
        <div>
            <p class="page-route">홈 > 창고 관리 > 위생점검 결과 > 등록</p>
        </div>
    </div>

    <form action="${pageContext.request.contextPath}/warehouse/glog/insert"
          method="post"
		...
		<div class="grid-wrap">
			<div class="grid search-item">
				<label>검사 대상</label>
				<input type="hidden" name="glogWhId" value="${whDTO.whId}">
				<input type="text" id="ghpWh" value="${whDTO.whName} (${whDTO.whId})" placeholder="검사 대상" required readonly>
			</div>
